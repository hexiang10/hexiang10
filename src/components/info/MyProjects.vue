    ...
    <el-collapse>
      <el-collapse-item name="1">
        ...
        <div>
          ...
          <br />
          🔔此项目为本人的毕业设计项目，基于本人参加第二届字节跳动青训营实践项目的拓展开发。
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item name="3">
        ...
        <div>
          ...
          📺讲解视频：<el-link
            :underline="false"
            href="https://www.bilibili.com/video/BV1JR4y1W7Vw"
            target="_blank"
            >bilibili.com/video/BV1JR4y1W7Vw</el-link
          >
          <br />
          📤本项目v2.0正在持续更新！敬请期待🙏
        </div>
      ...
      <el-collapse-item name="4">
        ...
        <div>
          ...
          »查看地址：<el-link
            :underline="false"
            href="https://github.com/hexiang10?tab=repositories"
            target="_blank"
            >github.com/hexiang10?tab=repositories</el-link
          >
        </div>
      </el-collapse-item>
    </el-collapse>
